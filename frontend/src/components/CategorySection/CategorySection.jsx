...
const categories = [
  { icon: drinksIcon, name: "เครื่องดื่ม" },
  { icon: bakeryIcon, name: "เบเกอรี่" },
  { icon: othersIcon, name: "สินค้าอื่นๆ" },
];
    ...
    return (
      <section className="py-10 bg-[#F5F5F5]">
        <div className="max-w-[1200px] mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold text-gray-800 mb-8 font-prompt">หมวดหมู่เมนูของเรา</h2>
